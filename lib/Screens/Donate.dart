...
import 'package:healthz/Screens/Transaction.dart';
import 'package:healthz/Wrapper/keyInterface.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:healthz/Wrapper/ethWrapper.dart';
import 'package:web3dart/web3dart.dart';
import 'package:toast/toast.dart';

class Donate extends StatefulWidget{
  DonateState createState () => new DonateState();
}
  ...
  Widget build(BuildContext context) {
    final logo = Hero(
      ...
      child: CircleAvatar(
        ...
        radius: 100.0,
        child: Image.asset('assets/images/fight.JPG'),
      ),
    );
    return Scaffold(
         ...
         child: RaisedButton(
           ...
           onPressed: () async {
             ...
             Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) =>
                 MaticTransactions()), (Route<dynamic> route) => false);
